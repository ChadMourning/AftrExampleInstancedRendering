...
#include <vector>
#include <memory>
#include "GLViewExampleInstancedRendering.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewExampleInstancedRendering > glView( Aftr::GLViewExampleInstancedRendering::New( args ) );
